<?php
	...
	bot::regcommand("msg", "$MODULE_NAME/friendlist.php", "friendlist", "admin");
	bot::regcommand("priv", "$MODULE_NAME/friendlist.php", "friendlist", "admin");
	bot::regcommand("guild", "$MODULE_NAME/friendlist.php", "friendlist", "admin");
