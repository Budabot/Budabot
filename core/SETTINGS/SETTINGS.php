<?php
	...
	bot::addsetting($MODULE_NAME, 'default_clan_color', "", 'edit', "<font color='#F79410'>", 'color');
	bot::addsetting($MODULE_NAME, 'default_omni_color', "", 'edit', "<font color='#00FFFF'>", 'color');
	bot::addsetting($MODULE_NAME, 'default_neut_color', "", 'edit', "<font color='#EEEEEE'>", 'color');
	bot::addsetting($MODULE_NAME, 'default_unknown_color', "", 'edit', "<font color='#FF0000'>", 'color');
