<?php
	...
	Setting::add($MODULE_NAME, "join_access_level", "Min access level to join the private channel", "edit", "options", "member", "all;member;guild;leader;raidleader;moderator;admin;superadmin;none");
