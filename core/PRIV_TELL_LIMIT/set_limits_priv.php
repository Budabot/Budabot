...
if(eregi("^minlvl$", $message)) {
    ...
    elseif($type == "guild")
       	bot::send($msg, "guild");
} elseif(eregi("^minlvl ([0-9]+)$", $message, $arr)) {
    ...
    elseif($type == "guild")
       	bot::send($msg, "guild");	
} elseif(eregi("^open (org|all|members)$", $message, $arr)) {
    ...
    elseif($type == "guild")
       	bot::send($msg, "guild"); 	
} elseif(eregi("^faction (omni|clan|neutral|all)$", $message, $arr)) {
    ...
    elseif($type == "guild")
       	bot::send($msg, "guild");
} elseif(eregi("^faction not (omni|clan|neutral)$", $message, $arr)) {
    ...
    elseif($type == "guild")
       	bot::send($msg, "guild");
} elseif(eregi("^maxplayers$", $message)) {
    ...
    elseif($type == "guild")
       	bot::send($msg, "guild"); 	 
} elseif(eregi("^maxplayer ([0-9]+)$", $message, $arr)) {
