<?php
	...
	Command::register($MODULE_NAME, "", "remalias.php", "remalias", "mod", "Remove a command alias");
	Command::register($MODULE_NAME, "", "addalias.php", "addalias", "mod", "Add a command alias");
