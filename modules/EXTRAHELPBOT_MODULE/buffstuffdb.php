...
"O.E.T. Co. Urban Sniper" 
	=> array("Weapon", "Various, depending on QL", "1-192", $mish_and_shop, "1: no boost", "38: +14 Shotgun", "80: no boost", "192: +30 Agility"),
"OT M50 Shotgun"
	=> array("Weapon", "Shotgun, for hotswapping", "1-200", $mish_and_shop, "1: no boost", "70: +15", "90: +20", "150: +25", "200: +30"),
"Bladestaff"
	=> array("Weapon", "2he, for hotswapping", "1-200", $mish_and_shop, "1: +1", "24: +2", "47: +5", "70: +10", "93: +15", "116: +20", 
			 "139: +25", "162: +30", "185: +35", "200: +50"),
"Tripler"
	=> array("Weapo", "1he, later on also Piercing", "1-200", $mish_and_shop,
...
"Galahad Inc. 055" 
	=> array("Weapon", "Various skills dependingon QL", "1-200", $mish_and_shop,
...
"MTI SW500"
	=> array("Weapon", "Pistol, later on also Multi ranged.", "1-180", $mish_and_shop, "1: no boost", "110: +20 Pistol", "180: +30 Pistol/Multi ranged."),
"BigBurger Inc." 
	=> array("Weapon", "Burst (for hotswapping)", "1-200", $mish_and_shop, "1: +0", "100: +30", "200: +40"),
"MTI B-94"
	=> array("Weapon", "% XP gain", "1-152", $mish_and_shop, "1: +0%","12: +1%", "22: +2%", "42: +3%", "62: +4%", "152: +5%"),
"OT-Windchaser M06 Rifle"
	=> array("Weapon", "Various, depending on QL", "1-170", $mish_and_shop,
...
"Ring of Presence"
	=> array("Armor", "Intel, Psychic, all nano skills, treatment, first aid, CompLit, Nanoprog., Psychology, Tutoring, Adventuring, Perception", 
			 "1-200, lvl locks", $dyna_mish, "1: +1", "35: +2", "100: +3", "167: +4"),
...
"Kirch Kevlar"
	=> array("Armor", "Agility, Psychic, Sense", "1-200", $dyna_mish, "1: +1", "26: +2",  "76: +3", "126: +4", "176: +5"),
"Sekutek Chilled Plasteel"
	=> array("Armor", "Agility, Intel, Sense", "1-200", $dyna_mish, "1: +1", "26: +2",  "76: +3", "126: +4", "176: +5"),
"Nova Dillon"
	=> array("Armor", "All base abilities",    "1-200", $dyna_mish, "1: +1", "35: +2", "101: +3", "167: +4"),
"Biomech"
