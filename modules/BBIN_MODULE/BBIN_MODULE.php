<?php
  ...
  bot::event("2sec", "$MODULE_NAME/bbin_loop.php", "none", "The main BBIN message loop");
	...
	//Settings
	bot::addsetting("bbin_status", "Status of BBIN uplink", "noedit", "0", "Offline;Online", "0;1", "mod", "$MODULE_NAME/bbin_help.txt");
	bot::addsetting("bbin_server", "IRC server to connect to", "noedit", "irc.funcom.com", "none", "0", "mod", "$MODULE_NAME/bbin_help.txt");
	bot::addsetting("bbin_port", "IRC server port to use", "noedit", "6667", "none", "0", "mod", "$MODULE_NAME/bbin_help.txt");
	bot::addsetting("bbin_nickname", "Nickname to use while in IRC", "noedit", "{$this->vars['name']}", "none", "0", "mod", "$MODULE_NAME/bbin_help.txt");
	bot::addsetting("bbin_channel", "Channel to join", "noedit", "$channel", "none", "0", "mod", "$MODULE_NAME/bbin_help.txt");
