...
$timezone["CST"]["time"] = gmdate($time_format, $time - (3600*6));
$timezone["CDT"]["name"] = "Central Daylight Time (GMT-5)";
$timezone["CDT"]["time"] = gmdate($time_format, $time - (3600*5));
$timezone["MST"]["name"] = "Mountain Standard Time (GMT-7)";
$timezone["MST"]["time"] = gmdate($time_format, $time - (3600*7));
$timezone["MDT"]["name"] = "Mountain Daylight Time (GMT-6)";
$timezone["MDT"]["time"] = gmdate($time_format, $time - (3600*6));
$timezone["PST"]["name"] = "Pacific Standard Time (GMT-8)";
$timezone["PST"]["time"] = gmdate($time_format, $time - (3600*8));
$timezone["PDT"]["name"] = "Pacific Daylight Time (GMT-7)";
$timezone["PDT"]["time"] = gmdate($time_format, $time - (3600*7));
$timezone["AKST"]["name"] = "Alaska Standard Time (GMT-9)";
$timezone["AKST"]["time"] = gmdate($time_format, $time - (3600*9));
$timezone["AKDT"]["name"] = "Alaska Daylight Time (GMT-8)";
$timezone["AKDT"]["time"] = gmdate($time_format, $time - (3600*8));
$timezone["EST"]["name"] = "Eastern Standard Time (GMT-5)";
$timezone["EST"]["time"] = gmdate($time_format, $time - (3600*5));
$timezone["EDT"]["name"] = "Eastern Daylight Time (GMT-4)";
$timezone["EDT"]["time"] = gmdate($time_format, $time - (3600*4));
$timezone["NST"]["name"] = "Newfoundland Standard Time (GMT-3:30)";
$timezone["NST"]["time"] = gmdate($time_format, $time - (3600*3.5));
$timezone["NDT"]["name"] = "Newfoundland Daylight Time (GMT-2:30)";
$timezone["NDT"]["time"] = gmdate($time_format, $time - (3600*2.5));
$timezone["GMT"]["name"] = "Greenwich Mean Time (GMT / AO)";
$timezone["GMT"]["time"] = gmdate($time_format, $time);
$timezone["CET"]["name"] = "Central European Time (GMT+1)";
$timezone["CET"]["time"] = gmdate($time_format, $time + 3600);
$timezone["CEST"]["name"] = "Central European Summer Time (GMT+2)";
$timezone["CEST"]["time"] = gmdate($time_format, $time + (3600*2));
$timezone["EET"]["name"] = "Eastern European Time (GMT+2)";
$timezone["EET"]["time"] = gmdate($time_format, $time + (3600*2));
$timezone["EEST"]["name"] = "Eastern European Summer Time (GMT+3)";
$timezone["EEST"]["time"] = gmdate($time_format, $time + (3600*3));
$timezone["EEDT"]["name"] = "Eastern European Daylight Time (GMT+3)";
$timezone["EEDT"]["time"] = gmdate($time_format, $time + (3600*3));
$timezone["MSK"]["name"] = "Moscow Time (GMT+3)";
$timezone["MSK"]["time"] = gmdate($time_format, $time + (3600*3));
$timezone["MSD"]["name"] = "Moscow Daylight Time (GMT+4)";
$timezone["MSD"]["time"] = gmdate($time_format, $time + (3600*4));
$timezone["IRT"]["name"] = "Iran Time (GMT+3:30)";
$timezone["IRT"]["time"] = gmdate($time_format, $time + (3600*3.5));
$timezone["IST"]["name"] = "Indian Standard Time (GMT+5:30)";
$timezone["IST"]["time"] = gmdate($time_format, $time + (3600*5.5));
$timezone["ICT"]["name"] = "Indochina Time (GMT+7)";
$timezone["ICT"]["time"] = gmdate($time_format, $time + (3600*7));
$timezone["CST"]["name"] = "China Standard Time (GMT+8)";
$timezone["CST"]["time"] = gmdate($time_format, $time + (3600*8));
$timezone["JST"]["name"] = "Japan Standard Time (GMT+9)";
$timezone["JST"]["time"] = gmdate($time_format, $time + (3600*9));
$timezone["ACST"]["name"] = "Australian Central Standard Time (GMT+9:30)";
$timezone["ACST"]["time"] = gmdate($time_format, $time + (3600*9.5));
$timezone["ACDT"]["name"] = "Australian Central Daylight Time (GMT+10:30)";
$timezone["ACDT"]["time"] = gmdate($time_format, $time + (3600*10.5));
$timezone["AEST"]["name"] = "Australian Eastern Standard Time (GMT+10)";
$timezone["AEST"]["time"] = gmdate($time_format, $time + (3600*10));
$timezone["AEDT"]["name"] = "Australian Eastern Daylight Time (GMT+11)";
$timezone["AEDT"]["time"] = gmdate($time_format, $time + (3600*11));
...
if (preg_match("/^time$/i", $message)) {
	...
	$msg = "<highlight>".gmdate("dS M, H:i:s", $time)."<end> (GMT/AO)";
