...
$FOLDER = $dir;
	...
	//Alien City Generals
	bot::command("msg", "$MODULE_NAME/aigen.php", "aigen", "guild", "Info about Alien City Generals(which VB큦 they drop)");	
	bot::command("priv", "$MODULE_NAME/aigen.php", "aigen", "all", "Info about Alien City Generals(which VB큦 they drop)");	
	bot::command("guild", "$MODULE_NAME/aigen.php", "aigen", "all", "Info about Alien City Generals(which VB큦 they drop)");	
    ...
    bot::help("whereis", "$MODULE_NAME/whereis.txt", "guild", "Show infos about NPC큦 and Locations", "Helpbot");
