...
CREATE TABLE EffectTypeMatrix (ID INT NOT NULL, Name VARCHAR(20) NOT NULL, MinValLow INT NOT NULL, MaxValLow INT NOT NULL, MinValHigh INT NOT NULL, MaxValHigh INT NOT NULL);
