<?php
	...
	Event::register($MODULE_NAME, "logOff", "orglist_check.php", "none", "Gets offline status of org members");
	Event::register($MODULE_NAME, "logOn", "is_online_check.php", "none", "Gets online status of player");
	Event::register($MODULE_NAME, "logOff", "is_online_check.php", "none", "Gets offline status of player");
