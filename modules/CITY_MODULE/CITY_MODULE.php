<?php
	...
	Event::register($MODULE_NAME, "logOn", "city_guild_logon.php", "city", "Show cloak status to guild members logging in");
	...
	Event::register($MODULE_NAME, "guild", "auto_start_wave_counter.php", "none", "Starts a wave counter when cloak is lowered");
