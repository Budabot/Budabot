<?php
	...
	//Commands
	Command::register($MODULE_NAME, "", "quotestats.php", "quoteupdate", "mod", "Update Quote Stats");
	Command::register($MODULE_NAME, "", "quote.php", "quote", "all", "Add/Remove/View Quotes");

	Setting::add($MODULE_NAME, "quote_add_min", "Minimum org level needed to add quote.", "edit", "-1", "Anyone;At least in Private chat;0;1;2;3;4;5;6", "-2;-1;0;1;2;3;4;5;6", "mod");
