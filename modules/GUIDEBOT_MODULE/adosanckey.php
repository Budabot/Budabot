...
$adosanckey_txt = "Adonis: Dalja Sanctuary Garden Key Quest
...
fter the quest is updated, you can then finish the process and make the pattern into a Novictalized Notum Crystal. Check our Pocket Boss Guide to learn how to complete the pattern. 
...
Make this pattern into a Novictalized Notum Crystal (same process as with the previous complete pattern). You already know where you can spawn the Diviner. When the he spawns he cannot be attacked for 6 minutes (this is because the clan version requires for players to talk to him), once this time runs out kill him. Loot 'Record of Lost Diviner' from his corpse 
...
if($type == "msg") 
bot::send($adosanckey_txt, $sender); 
elseif($type == "all") 
bot::send($adosanckey_txt); 
else 
bot::send($adosanckey_txt, "guild"); 
?>