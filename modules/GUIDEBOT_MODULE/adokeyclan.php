...
$adokeyclan_txt = "Adonis Garden Key Quest CLAN
...
"
;
$adokeyclan_txt = bot::makeLink("Adonis: Garden Key Quest CLAN", $adokeyclan_txt); 
if($type == "msg") 
bot::send($adokeyclan_txt, $sender); 
elseif($type == "all") 
bot::send($adokeyclan_txt); 
else 
bot::send($adokeyclan_txt, "guild"); 
?>