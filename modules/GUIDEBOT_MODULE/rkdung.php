<?php
$blob = "<header>::::: Guide To Rubi-Ka Static Dungeons  :::::<end>\n\n
<font color = red> Guide To Rubi-Ka Static Dungeons </font> 
...
$msg = bot::makeLink("Guide To Rubi-Ka Static Dungeons", $blob); 
bot::send($msg, $sendto);
?>