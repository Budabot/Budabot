...
$pirates = array(
	...
	"Elizabeth Swann: It never would've worked out between us.<br>Jack Sparrow: Keep telling yourself that, darling. ",
	"Will Turner: We're going to steal a ship? That ship?<br>Jack Sparrow: Commandeer. We're going to commandeer that ship. ",
  "Norrington: You actually were telling the truth.<br>Jack Sparrow: I do that quite a lot. Yet people are always surprised.",
  "Elizabeth Swann: Why doesn't your compass work?<br>Jack Sparrow: ...My compass works fine.",
  "Will Turner: I'd die for her.<brJack Sparrow: Oh good. No worries then.",
  ...
  "Will Turner: I row over, search the ship until I find your bloody key.<br>Jack Sparrow: And if there are crewmen?<br>Will Turner: I cut down anyone in my path.<br>Jack Sparrow: [turns to Gibbs] I like it. Simple, easy to remember. ",
  ...
  "Pintel: Your'e supposed to be dead!<br>Jack Sparrow: Am I not?",
  "Jack Sparrow: If you were waiting for the opportune moment, that was it.",
  "Elizabeth Swann: You're despicable.<br>Jack Sparrow: Sticks and stones, love. I saved your life, you saved mine. We're square.",
  "Jack Sparrow: You seem somewhat familiar. Have I threatened you before?<br>Will Turner: I make a point of avoiding familiarity with pirates.",
  "Barbossa: Why thank ye, Jack.<br>Jack Sparrow: You're welcome.<br>Barbossa: Oh, not you. We named the monkey Jack. ",
  "Will Turner: That's not true. I am not obsessed with treasure.<br>Jack Sparrow: Not all treasure is silver and gold, mate.",
  "Harbormaster: Hold up there, you. It's a shilling to tie up your boat at the dock... and I shall need to know your name.<br>Jack Sparrow: What do you say to three shillings and we forget the name.<br>Harbormaster: Welcome to Port Royal, Mr. Smith.",
  ...
  "Jack Sparrow: Elizabeth!<br>[Turns to Gibbs]<br>Jack Sparrow: Hide the rum. ",
  "Jack Sparrow: We are very much alike, you and I, I and you... us.<br>Elizabeth Swann: Oh. Except for a sense of honor and decency and a moral center. And personal hygiene.<br>Jack Sparrow: [Sniffs his armpit and looks back] Trifles. ",
  "Elizabeth Swann: There will come a moment when you will have a chance to show it. To do the right thing.<br>Jack Sparrow: I love those moments. I like to wave at them as they pass by. ",
  ...
  "Elizabeth Swann: That's it, then? That's the secret grand adventure of the infamous Jack Sparrow - you spent three days lying on a beach drinking rum?<br>Jack Sparrow: Welcome to the Caribbean, love.",
  ...
  "Lord Cutler Beckett: It's nothing personal, Jack. It's just good business.",
...
if (preg_match("/^pirates/i", $message)) {
	$sendto->reply(Util::rand_array_value($pirates));
} else {
	$syntax_error = true;
}
