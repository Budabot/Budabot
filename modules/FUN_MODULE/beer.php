<?php
   ...
   ** Some entries taken from a module written by Wood of Exalted (Aquilonia EU) for Bebot: http://bebot.shadow-realm.org/generic-custom-modules/social-mods-blackadder-beer
