...
if ($type == "priv") {
	...
	$msg = "<end>" . Setting::get("guest_color_channel") . "[Guest]<end> " . Setting::get("guest_color_username") . Text::make_link($sender,$sender,"user")."<end>: " . Setting::get("guest_color_guild") . $message . "<end>";
	...
	if ($sender == '-1') {
		...
		$msg = "<end>" . Setting::get("guest_color_channel") . "[{$this -> vars["my guild"]}]<end> " . Setting::get("guest_color_guest") . $message . "<end>";
	} else {
		$msg = "<end>" . Setting::get("guest_color_channel") . "[{$this -> vars["my guild"]}]<end> " . Setting::get("guest_color_username") . Text::make_link($sender,$sender,"user")."<end>: " . Setting::get("guest_color_guest") . $message . "<end>";
	}
