...
$PLUGIN_VERSION = 0.1;
	...
	bot::command("guild", "$MODULE_NAME/alts.php", "altsadmin", "mod", "Alt Char handling (admin)");
	bot::command("msg", "$MODULE_NAME/alts.php", "altsadmin", "mod", "Alt Char handling (admin)");
	bot::command("priv", "$MODULE_NAME/alts.php", "altsadmin", "mod", "Alt Char handling (admin)");
