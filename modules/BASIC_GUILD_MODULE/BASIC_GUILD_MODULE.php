<?php
	...
	bot::command("", "$MODULE_NAME/alts.php", "altsadmin", MODERATOR, "Alt Char handling (admin)");
	...
	bot::command("msg", "$MODULE_NAME/updateorg.php", "updateorg", MODERATOR, "Forcing an update of the org roster");
	...
	//Helpfile
    bot::help("afk_kiting", "$MODULE_NAME/afk_kiting.txt", GUILDMEMBER, "Set yourself AFK/Kiting");
    bot::help("alts", "$MODULE_NAME/alts.txt", GUILDMEMBER, "How to set alts");
	bot::help("altsadmin", "$MODULE_NAME/altsadmin.txt", GUILDMEMBER, "How to set alts (admins)");
    bot::help("LogOnMsg", "$MODULE_NAME/logonmsg.txt", GUILDMEMBER, "Changing your logon message");
    bot::help("OrgMembers", "$MODULE_NAME/orgmembers_orgranks.txt", GUILDMEMBER, "Show current OrgMembers");
    bot::help("tell_guild", "$MODULE_NAME/tell.txt", GUILDMEMBER, "Repeat a msg 3times/Send a tell to online members");
    bot::help("updateorg", "$MODULE_NAME/updateorg.txt", MODERATOR, "Force an update of orgrooster");
?>