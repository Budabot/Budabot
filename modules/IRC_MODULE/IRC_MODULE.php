<?php
   ...
   */
	...
	//Settings
	Setting::add($MODULE_NAME, "irc_status", "Status of IRC uplink", "noedit", "options", "0", "Offline;Online", "0;1", "mod", "$MODULE_NAME/irc_help.txt");
	Setting::add($MODULE_NAME, "irc_server", "IRC server to connect to", "noedit", "text", "irc.funcom.com", "", "", "mod", "$MODULE_NAME/irc_help.txt");
	Setting::add($MODULE_NAME, "irc_port", "IRC server port to use", "noedit", "number", "6667", "", "", "mod", "$MODULE_NAME/irc_help.txt");
	Setting::add($MODULE_NAME, "irc_nickname", "Nickname to use while in IRC", "noedit", "text", $chatBot->vars['name'], "", "", "mod", "$MODULE_NAME/irc_help.txt");
	Setting::add($MODULE_NAME, "irc_channel", "Channel to join", "noedit", "text", $channel, "", "", "mod", "$MODULE_NAME/irc_help.txt");
	Setting::add($MODULE_NAME, "irc_autoconnect", "Connect to IRC at bootup", "edit", "options", "0", "true;false", "1;0", "mod", "$MODULE_NAME/irc_help.txt");
	Setting::add($MODULE_NAME, "irc_debug_ping", "IRC Debug Option: Show pings in console", "edit", "options", "0", "true:false", "1;0", "mod", "$MODULE_NAME/irc_help.txt");
	Setting::add($MODULE_NAME, "irc_debug_messages", "IRC Debug Option: Show events in console", "edit", "options", "0", "true:false", "1;0", "mod", "$MODULE_NAME/irc_help.txt");
	Setting::add($MODULE_NAME, "irc_debug_all", "IRC Debug Option: Log everything", "edit", "options", "0", "true;false", "1;0", "mod", "$MODULE_NAME/irc_help.txt");
