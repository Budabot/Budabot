...
if (preg_match("/^apf (13|28|35)$/i", $message, $arr)) {
	...
	$tradelink["ICE"] = "<a href='chatcmd:///tell <myname> apfloot Hacker ICE-Breaker Source'>Click here</a>";
	$itemlink["ICE"] = Text::make_item(257968, 257968, 1, "Hacker ICE-Breaker Source");
	$tradelink["BOARD"] = "<a href='chatcmd:///tell <myname> apfloot KyrOzch Helmet'>Click here</a>";
	$itemlink["BOARD"] = Text::make_item(257706, 257706, 1, "Kyr'Ozch Helmet");
	$tradelink["APE"] = "<a href='chatcmd:///tell <myname> apfloot Action Probability Estimator'>Click here</a>";
	$itemlink["APE"] = Text::make_item(257960, 257960, 250, "Action Probability Estimator");
	$tradelink["DGRV"] = "<a href='chatcmd:///tell <myname> apfloot Dynamic Gas Redistribution Valves'>Click here</a>";
	...
	$tradelink["BELT"] = "<a href='chatcmd:///tell <myname> apfloot Inertial Adjustment Processing Unit'>Click here</a>";
