...
$itemlink["NPI"] = bot::makeItem(161699, 161699, 1, "Nano Programming Interface");
...
$itemlink["KMPH"] = bot::makeItem(252017, 252017, 200, "Kegern's Molybdenum Plate Helmet");
$itemlink["JMPH"] = bot::makeItem(252005, 252005, 200, "Jathos' Molybdenum Plate Helmet");
$itemlink["EMCH"] = bot::makeItem(257379, 257379, 200, "Extruder's Molybdenum Crash Helmet");
$itemlink["SKH"] = bot::makeItem(225514, 225514, 200, "Sworn Knight's Helmet");
$itemlink["CKH"] = bot::makeItem(225541, 225541, 200, "Conscientious Knight's Helmet");
$itemlink["LOA"] = bot::makeItem(244821, 244821, 300, "Lord of Angst");
$itemlink["KR2"] = bot::makeItem(254478, 254478, 250, "Kyr'Ozch Rifle - Type 2");
$itemlink["KR3"] = bot::makeItem(254485, 254485, 250, "Kyr'Ozch Rifle - Type 3");
$itemlink["ESC"] = bot::makeItem(160162, 160162, 200, "Excellent Sleek Cannon");
$itemlink["VDS"] = bot::makeItem(251225, 251225, 200, "Viral Data Storage");
$itemlink["DBWM"] = bot::makeItem(257540, 257540, 250, "Disassembled Belt with Memory");
$itemlink["OC"] = bot::makeItem(251221, 251221, 200, "Overheated Compiler");
$itemlink["DBWMAC"] = bot::makeItem(257541, 257541, 250, "Disassembled Belt with Memory and Compiler");
$itemlink["COP"] = bot::makeItem(253153, 253153, 200, "Cannister of Powder");
$itemlink["DKP"] = bot::makeItem(165168, 165168, 250, "Diamondine Kick Pistol");
$itemlink["LRDKP"] = bot::makeItem(257109, 257109, 300, "Low Recoil Diamondine Kick Pistol");
$itemlink["MM"] = bot::makeItem(233335, 233335, 250, "Murder Maul");
$itemlink["LMM"] = bot::makeItem(257111, 257111, 300, "Lightened Murder Maul");
$itemlink["AHSC"] = bot::makeItem(201939, 201939, 190, "Augmented Hellspinner Shock Cannon");
$itemlink["AMC"] = bot::makeItem(244376, 244376, 250, "Aquarius's Multitask Calculator");
$itemlink["KER992"] = bot::makeItem(254723, 254723, 250, "Kyr'Ozch Energy Rapier - Type 992");
$itemlink["LPBASG"] = bot::makeItem(231235, 231235, 1, "Lava Protection Boots and Skin Galvanizer");
$itemlink["VNGW"] = bot::makeItem(257123, 257123, 300, "Vektor ND Grand Wyrm");	
$itemlink["VNDS"] = bot::makeItem(124262, 124262, 180, "Vektor ND DRAGON Shotgun");	
$itemlink["CC"] = bot::makeItem(125456, 125456, 10, "Concrete Cushion");	
$itemlink["HRPSAG"] = bot::makeItem(231236, 231236, 1, "Hyper-Radiation Protection Skin and Glasses");	
