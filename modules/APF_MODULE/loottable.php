...
if(preg_match("/^loottable (13|28|35)$/i", $message, $arr)) {
	...
	$itemlink["ICE"] = $this->makeItem(257968, 257968, 1, "Hacker ICE-Breaker Source");
	$tradelink["BOARD"] = "<a href='chatcmd:///tell <myname> guide KyrOzch Helmet'>Click here</a>";
	$itemlink["BOARD"] = $this->makeItem(257706, 257706, 1, "Kyr'Ozch Helmet");
	$tradelink["APE"] = "<a href='chatcmd:///tell <myname> guide Action Probability Estimator'>Click here</a>";
	$itemlink["APE"] = $this->makeItem(257960, 257960, 250, "Action Probability Estimator");
	$tradelink["DGRV"] = "<a href='chatcmd:///tell <myname> guide Dynamic Gas Redistribution Valves'>Click here</a>";
	$itemlink["DGRV"] = $this->makeItem(257962, 257962, 250, "Dynamic Gas Redistribution Valves");
	$itemlink["KBAP"] = $this->makeItem(257529, 257529, 1, "Kyr'Ozch Battlesuit Audio Processor");
	$itemlink["KVPU"] = $this->makeItem(257533, 257533, 1, "Kyr'Ozch Video Processing Unit");
	$itemlink["KRI"] = $this->makeItem(257531, 257531, 1, "Kyr'Ozch Rank Identification");	
	$itemlink["ICEU"] = $this->makeItem(257110, 257110, 1, "Intrusion Countermeasure Electronics Upgrade");
	$itemlink["OTAE"] = $this->makeItem(257112, 257112, 1, "Omni-Tek Award - Exemplar");
	$itemlink["CMP"] = $this->makeItem(257113, 257113, 1, "Clan Merits - Paragon");
	$itemlink["EMCH"] = $this->makeItem(257379, 257379, 200, "Extruder's Molybdenum Crash Helmet");
	$itemlink["CKCNH"] = $this->makeItem(257115, 257115, 200, "Conscientious Knight Commander Nizno's Helmet");
	$itemlink["SKCGH"] = $this->makeItem(257114, 257114, 200, "Sworn Knight Commander Genevra's Helmet");
	$itemlink["BCOH"] = $this->makeItem(257383, 257383, 300, "Blackmane's Combined Officer's Headwear");		
	$itemlink["GCCH"] = $this->makeItem(257381, 257381, 300, "Gannondorf's Combined Commando's Headwear");		
	$itemlink["HCSH"] = $this->makeItem(257384, 257384, 300, "Haitte's Combined Sharpshooter's Headwear");		
	$itemlink["OCPH"] = $this->makeItem(257377, 257377, 300, "Odum's Combined Paramedic's Headwear");		
	$itemlink["SCMH"] = $this->makeItem(257380, 257380, 300, "Sillum's Combined Mercenary's Headwear");		
	$itemlink["YCSH"] = $this->makeItem(257382, 257382, 300, "Yakomo's Combined Scout's Headwear");		
	$itemlink["HLOA"] = $this->makeItem(257128, 257128, 300, "High Lord of Angst");
	$itemlink["SKR2"] = $this->makeItem(257967, 257967, 300, "Silenced Kyr'Ozch Rifle - Type 2");
	$itemlink["SKR3"] = $this->makeItem(257131, 257131, 300, "Silenced Kyr'Ozch Rifle - Type 3");
	$itemlink["ASC"] = $this->makeItem(257126, 257126, 300, "Amplified Sleek Cannon");
	$itemlink["IAPU"] = $this->makeItem(257959, 257959, 1, "Inertial Adjustment Processing Unit");
	$itemlink["HVBCP"] = $this->makeItem(257119, 257119, 300, "Hadrulf's Viral Belt Component Platform");
	$tradelink["BELT"] = "<a href='chatcmd:///tell <myname> guide Inertial Adjustment Processing Unit'>Click here</a>";
	$itemlink["NAC"] = $this->makeItem(257963, 257963, 250, "Notum Amplification Coil");
	$itemlink["TAHSC"] = $this->makeItem(257124, 257124, 300, "Twice Augmented Hellspinner Shock Cannon");
	$itemlink["ONC"] = $this->makeItem(257118, 257118, 250, "ObiTom's Nano Calculator");
	$itemlink["AKC12"] = $this->makeItem(257143, 257143, 300, "Amplified Kyr'Ozch Carbine - Type 12");
	$itemlink["AKC13"] = $this->makeItem(257142, 257142, 300, "Amplified Kyr'Ozch Carbine - Type 13");
	$itemlink["AKC5"] = $this->makeItem(257144, 257144, 300, "Amplified Kyr'Ozch Carbine - Type 5");	
	$tradelink["NAC"] = "<a href='chatcmd:///tell <myname> guide Notum Amplification Coil'>Click here</a>";
	$itemlink["ERU"] = $this->makeItem(257961, 257961, 250, "Energy Redistribution Unit");	
	$itemlink["BOB"] = $this->makeItem(257147, 257147, 300, "Blades of Boltar");	
	$itemlink["DVLPR"] = $this->makeItem(257116, 257116, 1, "De'Valos Lava Protection Ring");	
	$tradelink["ERU"] = "<a href='chatcmd:///tell <myname> guide Energy Redistribution Unit'>Click here</a>";
	$itemlink["VLRD"] = $this->makeItem(257964, 257964, 250, "Visible Light Remodulation Device");	
	$itemlink["DVRPR"] = $this->makeItem(257117, 257117, 1, "De'Valos Radiation Protection Ring");	
	$itemlink["SSSS"] = $this->makeItem(257141, 257141, 300, "Scoped Salabim Shotgun Supremo");	
