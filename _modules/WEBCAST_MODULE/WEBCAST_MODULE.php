<?php
	...
	// Events
	Event::register($MODULE_NAME, "logOn", "webcast.php", "Updates the list when someone logs on");
	Event::register($MODULE_NAME, "15mins", "webcast.php", "Updates the list every 15 minutes");
//	Event::register($MODULE_NAME, "logOff", "webcast.php", "Updates the list when someone logs off");
